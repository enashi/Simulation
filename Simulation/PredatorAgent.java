public class PredatorAgent extends Agent
{
    ...
    public void step( )
    {
        ...
        for ( int i = 0; i <_world.agents.size(); i++ )
        {
            ...
            {
                if (((a._x == this._x+1) && (a._y == this._y)) && (destination_valide(_x,_y,2))) //est
                {
                    _orient = 2;
                    a_poursuivi = true;
                }
                ...
                {
                    if (((a._x == this._x) && (a._y == this._y+1)) && (destination_valide(_x,_y,4))) //sud
                    {
                        _orient = 4;
                        a_poursuivi = true;
                    }
                    ...
                    {
                        if (((a._x == this._x-1) && (a._y == this._y)) && (destination_valide(_x,_y,6))) //ouest
                        {
                            _orient = 6;
                            a_poursuivi = true;
                        }
                        ...
                        {
                            if (((a._x == this._x) && (a._y == this._y-1)) && (destination_valide(_x,_y,0))) //nord
                            {
                                _orient = 0;
                                a_poursuivi = true;
                            }
                            ...
                            {
                                if (((a._x == this._x+1) && (a._y == this._y-1)) && (destination_valide(_x,_y,1))) //nord-est
                                {
                                    _orient = 1;
                                    a_poursuivi = true;
                                }
                                ...
                                {
                                    if (((a._x == this._x+1) && (a._y == this._y+1)) && (destination_valide(_x,_y,3))) //sud-est
                                    {
                                        _orient = 3;
                                        a_poursuivi = true;
                                    }
                                    ...
                                    {
                                        if (((a._x == this._x-1) && (a._y == this._y+1)) && (destination_valide(_x,_y,5))) //sud-ouest
                                        {
                                            _orient = 5;
                                            a_poursuivi = true;
                                        }
                                        ...
                                        {
                                            if (((this._x+1 == a._x) && (a._y == this._y-1)) && (destination_valide(_x,_y,7))) //nord-ouest
                                            {
                                                _orient = 7;
                                                a_poursuivi = true;
                                            }
        ...
        if(vie == 0)
        {
            ...
            System.out.println(" une poule a ete mange");
        }
